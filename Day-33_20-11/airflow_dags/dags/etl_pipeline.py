...
ASTRO_DB = "postgresql+psycopg2://postgres:postgres@host.docker.internal:5432/merged_database"
...
def transform_data():
    ...
    # print("Merged Data:")
    # print(merged.head())
    merged2 = merged.where(pd.notnull(merged), None)

    return merged2.to_dict(orient="records")
